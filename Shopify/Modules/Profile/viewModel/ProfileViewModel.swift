...
class ProfileViewModel: ProfileViewModelProtocol{
    ...
    func getOrdersFromNetworkService() {
        fetchDataFromApi.getDataFromApi(url: fetchDataFromApi.formatUrl(baseUrl: Constants.baseUrl, request: "orders", query: "customer_id", value: "7423232082091")){[weak self] (complectedOrders: ComplectedOrder) in
